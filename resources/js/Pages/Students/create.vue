                        ...
                        <form class="max-w-sm mx-auto" @submit.prevent="storeStudent">
                            <div class="mb-5">
                                ...
                                <input id="name" v-model="form.name"
                                       class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm
                            ...
                            <div class="mb-5">
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                    Student Age</label>
                                <input id="age" v-model="form.age" class="shadow-sm bg-gray-50 border border-gray-300
                            ...
                            <button
                                class=" mb-5 text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none
